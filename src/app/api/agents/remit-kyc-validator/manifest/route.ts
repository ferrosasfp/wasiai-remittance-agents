...
// misma forma que `src/app/api/agents/remit-kyc-validator/invoke/route.ts:9-31` (body de error fijo
// y opaco, console.warn sólo con datos value-free, nunca un 500).
