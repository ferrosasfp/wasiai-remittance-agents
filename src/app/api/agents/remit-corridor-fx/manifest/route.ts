// src/app/api/agents/remit-corridor-fx/manifest/route.ts
// Ficha de cobro del agente, hermana de /invoke. Wrapper fino sobre buildManifest (lib pura):
// misma forma que `src/app/api/agents/remit-corridor-fx/invoke/route.ts` (body de error fijo y
...
// `remit-corridor-fx-solana` (lo resuelve el registry). La asimetría es deliberada.
...
const PATH_SLUG = "remit-corridor-fx";
